...
<html>
  <head>
    ...
    <title>Control Asistencia | PMisiones </title>
...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-logo">
    <a href="#"><b>Control Asistencia Virtual</b> </a></br>

    <a href="#"><b></b> Parroquia Nuestra Señora de las Misiones</a>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="../admin/files/negocio/MISINOES.png" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
